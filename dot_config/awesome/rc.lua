...
local globalkeys = gears.table.join(
    ...
    -- resize client by direction
    awful.key(
        { modkey, "Ctrl" }, "j",
        function() awful.client.incwfact(-0.05) end,
        { description = "resize by direction down", group = "layout" }
    ),
    awful.key(
        { modkey, "Ctrl" }, "k",
        function() awful.client.incwfact(0.05) end,
        { description = "resize by direction up", group = "layout" }
    ),
    awful.key(
        { modkey, "Ctrl" }, "h",
        function() awful.tag.incmwfact(-0.05) end,
        { description = "resize by direction left", group = "layout" }
    ),
    awful.key(
        { modkey, "Ctrl" }, "l",
        function() awful.tag.incmwfact(0.05) end,
        { description = "resize by direction right", group = "layout" }
    ),
    ...
    awful.key(
        { modkey, "Shift" }, "o",
        function(c) awful.client.movetoscreen(c) end,
