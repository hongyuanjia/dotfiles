...
lazy.setup({
            ...
            config = function()
                ...
                local on_attach = function(client, bufnr)
                    vim.keymap.set("n", "gpi", "<cmd>Glance implementations<CR>",
                        { buffer = bufnr, desc = "Glance: Preview implementations" })
                    vim.keymap.set("n", "gpr", "<cmd>Glance references<CR>",
                        { buffer = bufnr, desc = "Glance: Preview references" })
                    vim.keymap.set("n", "gpd", "<cmd>Glance definitions<CR>",
                        { buffer = bufnr, desc = "Glance: Preview definitions" })
                    ...
                    if client.name == "rust-analyzer" then
                        vim.keymap.set("n", "<LocalLeader>rr", function() vim.cmd.RustLsp("run") end,
                            { buffer = bufnr, desc = "Rust: Run" })
                        vim.keymap.set("n", "<LocalLeader>xm", function() vim.cmd.RustLsp("expandMacro") end,
                            { buffer = bufnr, desc = "Rust: Expand macros" })
                        vim.keymap.set("n", "ga", function() vim.cmd.RustLsp('codeAction') end,
                            { buffer = bufnr, desc = "Rust: Code actions" })
                        vim.keymap.set("n", "<LocalLeader>oc", function() vim.cmd.RustLsp('openCargo') end,
                            { buffer = bufnr, desc = "Rust: Open Cargo.toml" })
                        vim.keymap.set("n", "<LocalLeader>rh", function() vim.cmd.RustLsp('openDocs') end,
                            { buffer = bufnr, desc = "Rust: Open docs under the cursor" })
                        vim.keymap.set({ "n", "v" }, "<LocalLeader>j", function() vim.cmd.RustLsp('joinLines') end,
                    ...
                    vim.keymap.set("n", "<Leader>lI", "<cmd>LspInstallInfo<CR>",
                        { buffer = bufnr, desc = "Lsp: Install info" })
                    ...
                    vim.keymap.set("n", "<Leader>lF", function() vim.lsp.buf.format { timeout_ms = 10000 } end,
                        { buffer = bufnr, desc = "Lsp: Format buffer" })
                    vim.keymap.set("n", "<Leader>lr", vim.lsp.buf.rename,
                        { buffer = bufnr, desc = "Lsp: Rename under cursor" })
        ...
        },
        {
            ...
            function! CommentOperatorFake(type) abort
                ...
                vim.keymap.set("n", "gcc", "<cmd>set operatorfunc=CommentOperatorFake<CR>g@l",
                    { desc = "Comment/uncomment line" })
                vim.keymap.set("n", "gc", "<cmd>set operatorfunc=CommentOperatorFake<CR>g@",
                    { desc = "Comment/uncomment line" })
                vim.keymap.set("x", "gc", ":<C-u>call CommentOperatorFake(visualmode())<CR>",
                    { desc = "Comment/uncomment line" })
            end,
            config = function()
        ...
        -- Git
        {
            ...
            init = function()
                ...
                -- <Leader>g[it]
                vim.keymap.set("n", "<Leader>gj", function() require("gitsigns").nav_hunk('next', { preview = true }) end,
                    { desc = "Next hunk" })
                vim.keymap.set("n", "<Leader>gk", function() require("gitsigns").nav_hunk('prev', { preview = true }) end,
                    { desc = "Previous hunk" })
                ...
                vim.keymap.set("n", "<Leader>gl", function() require("gitsigns").setloclist() end,
                    { desc = "List all changes in location list" })
        ...
        -- R
        {
            ...
            config = function()
                ...
                local r_set_keymap_targets = function(buffer)
                    ...
                    vim.keymap.set("n", "<LocalLeader>tm", "<cmd>lua require('r.send').cmd('targets::tar_make()')<CR>",
                        { buffer = buf, desc = "Make targets" })
                    vim.keymap.set("n", "<LocalLeader>tM",
                        "<cmd>lua require('r.send').cmd('targets::tar_make(callr_function = NULL)')<CR>",
                        { buffer = buf, desc = "Make targets in current session" })
                    vim.keymap.set("n", "<LocalLeader>tf",
                        "<cmd>lua require('r.send').cmd('targets::tar_make(use_crew = TRUE)')<CR>",
                        { buffer = buf, desc = "Make targets in parallel" })
                    vim.keymap.set("n", "<LocalLeader>tp", "<cmd>lua require('r.run').action('targets::tar_read')<CR>",
                    ...
                    vim.keymap.set("n", "<LocalLeader>tt",
                        function()
                            ...
                            cmd = cmd ..
                                "; targets::tar_make('" ..
                                word .. "', callr_function = NULL, use_crew = FALSE, as_job = FALSE)"
                ...
                local r_set_keymap_debug = function(buffer)
                    local buf = buffer == nil and 0 or buffer
                    vim.keymap.set("n", "<LocalLeader>tb", "<cmd>lua require('r.send').cmd('traceback()')<CR>",
                        { buffer = buf, desc = "Send 'trackback()'" })
                    vim.keymap.set("n", "<LocalLeader>sq", "<cmd>lua require('r.send').cmd('Q')<CR>",
                        { buffer = buf, desc = "Send 'Q' in debug mode" })
                    vim.keymap.set("n", "<LocalLeader>sc", "<cmd>lua require('r.send').cmd('c')<CR>",
                        { buffer = buf, desc = "Send 'c' in debug mode" })
                    vim.keymap.set("n", "<LocalLeader>sn", "<cmd>lua require('r.send').cmd('n')<CR>",
                        { buffer = buf, desc = "Send 'n' in debug mode" })
                    vim.keymap.set("n", "<LocalLeader>vp",
                        "<cmd>lua require('r.send').cmd('print(.Last.value, n = Inf)')<CR>",
                        { buffer = buf, desc = "Print .Last.value with maximum rows" })
                ...
                local r_set_keymap_devtools = function(buffer)
                    local buf = buffer == nil and 0 or buffer
                    vim.keymap.set("n", "<LocalLeader>da", function() r_dev_cmd("load_all") end,
                        { buffer = buf, desc = "Load package" })
                    vim.keymap.set("n", "<LocalLeader>dd", function() r_dev_cmd("document") end,
                        { buffer = buf, desc = "Document package" })
                    vim.keymap.set("n", "<LocalLeader>dt", function() r_dev_cmd("test") end,
                        { buffer = buf, desc = "Test package" })
                    vim.keymap.set("n", "<LocalLeader>dc", function() r_dev_cmd("check") end,
                        { buffer = buf, desc = "Check package" })
                    vim.keymap.set("n", "<LocalLeader>dr", function() r_dev_cmd("build_readme") end,
                        { buffer = buf, desc = "Build package README" })
                    vim.keymap.set("n", "<LocalLeader>dI", function() r_dev_cmd("install") end,
                        { buffer = buf, desc = "Install package" })
